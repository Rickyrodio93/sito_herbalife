...
export default function BigliettoDigitale() {
    return (
        <div
            className="min-h-screen flex flex-col items-center justify-between px-6 py-14 font-poppins selection:bg-[#B08D57]/20"
            style={{
                background: "radial-gradient(circle at 20% 15%, #1c3f26 0%, #0f1a15 45%, #0a120e 100%)"
            }}
        >
            <style>{`
        @keyframes sheen {
      ...
      `}</style>
            ...
            <div className="w-full max-w-sm flex flex-col items-center grow justify-center">
                {/* CARTA */}
                <div className="relative w-full rounded-[1.75rem] bg-[#14231D] border border-[#B08D57]/40 shadow-[0_20px_50px_-15px_rgba(20,35,29,0.5)] px-8 pt-10 pb-8 overflow-hidden">
                    {/* riflesso metallico */}
                    ...
                    <div className="relative flex flex-col items-center text-center">
                        ...
                        <h1 className="font-rancho text-4xl text-[#F6F3EC] leading-none mb-2">
                            Riccardo Rodio
                        </h1>
                ...
                <div className="w-full grid grid-cols-2 gap-3 mt-6">
                    <a
                        href="/contatto.vcf"
                        download
                        className="flex flex-col items-center justify-center gap-1.5 py-4 bg-[#14231D] hover:bg-[#1c2f26] text-[#F6F3EC] font-semibold rounded-2xl shadow-sm transition-all active:scale-[0.98] text-sm"
                    >
                ...
                <div className="w-full flex items-center gap-3 mt-9 mb-3">
                    <div className="grow border-t border-[#F6F3EC]/10" />
                    <span className="text-[10px] text-[#F6F3EC]/45 uppercase trackink-[0.25em] font-semibold">
                        I miei link
                    </span>
                    <div className="grow border-t border-[#F6F3EC]/10" />
                </div>
                ...
                <div className="w-full relative pl-5">
                    <div className="absolute left-1.5 top-2 bottom-2 w-px bg-[#14231D]/10" />
                    <div className="flex flex-col">
                        {LINK.map(({ href, icon: Icon, label, nota }) => (
                            <a
                                ...
                                className="group relative flex items-center justify-between py-4 border-b border-[#F6F3EC]/8 last:border-0"
                            >
                                <span className="absolute -left-5 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-[#0f1a15] border-2 border-[#B08D57]/50 group-hover:bg-[#B08D57] transition-colors" />
                                <span className="flex items-center gap-3.5">
                                    <span className="flex items-center justify-center w-9 h-9 rounded-full bg-[#F6F3EC]/8 text-[#2F5233] group-hover:bg-[#2F5233] group-hover:text-[#F6F3EC] transition-colors">
                                        <Icon size={16} />
                                    </span>
                                    <span className="flex flex-col text-left">
                                        <span className="font-semibold text-[#F6F3EC] text-[15px]">
                                            {label}
                                        </span>
                                        <span className="text-[11px] text-[#F6F3EC]/45">{nota}</span>
                                    </span>
                                </span>
                                <ArrowRight
                                    size={16}
                                    className="text-[#F6F3EC]/30 group-hover:text-[#B08D57] group-hover:translate-x-0.5 transition-all"
                                />
                            </a>
                        ))}
                    </div>
