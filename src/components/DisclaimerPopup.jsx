  ...
  return (
    <>
      <div className="fixed inset-0 bg-[rgba(0,0,0,0.5)] dark:bg-[rgba(0,0,0,0.65)] bg-opacity-60 flex items-center justify-center z-999999">
        ...
        >
          <div className="border-3 border-(--color-herbalife-4) dark:border-(--color-herbalife-1) p-4 text-gray-600 dark:text-white rounded-xl">
            <p className="mb-6">
              Questo sito web è gestito dal distributore indipendente Herbalife:
            ...
            <div className="mb-6 flex flex-col sm:flex-row">
              <div className="w-full sm:w-1/2 px-5">
                ...
                <p>
                  ...
                  invitiamo ad acquistare i tuoi prodotti dal Distributore con
                  cui sei già in contatto. La relazione personale con il tuo
                  Distributore è la chiave per raggiungere i tuoi obiettivi
                  nutrizionali. Hai un obiettivo di benessere?{" "}
                  <a
              ...
              <div className="w-full sm:w-1/2 px-5 mt-10 sm:mt-0 border-l-0 sm:border-l-2 border-(--color-herbalife-4) dark:border-(--color-herbalife-1)">
                ...
                <p>
                  Se vuoi diventare distibutore o anche solo saperne di più su
                  come potersi costruire una entrata extra con questa attività,{" "}
                  <a
            ...
            <div>
              <p className="mb-4">Continua con la navigazione nel sito cliccando qui sotto</p>
              <button
                onClick={OnClose}
