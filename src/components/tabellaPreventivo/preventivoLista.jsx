        ...
        {haBioniq && (
          <div className="mb-5 text-left p-3.5 rounded-xl border border-amber-500/20 bg-amber-500/5 dark:bg-amber-500/10 text-amber-950 dark:text-amber-200 normal-case shadow-inner">
            <div className="flex items-start gap-2 text-xs leading-relaxed">
              ...
              <div>
                <strong className="font-bold">Si prega di notare:</strong> Bioniq è un integratore personalizzato che richiede una gestione dedicata, deve essere acquistato come ordine separato ed essendo personalizzato non è rimborsabile.
              </div>
            </div>
            ...
            {haOrdineMisto && (
              <div className="mt-2.5 text-[11px] font-black text-red-600 dark:text-red-400 border-t border-amber-500/10 pt-2 flex items-start gap-1">
                <span><X size={14}/></span>
                <span>L&apos;ordine non può essere misto. Rimuovi i prodotti classici o il prodotto Bioniq per procedere.</span>
              </div>
            )}
